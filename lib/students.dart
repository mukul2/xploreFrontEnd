  ...
  DataRow getRow(int index) {
    return DataRow(cells: [
      ...
      DataCell(TextButton(onPressed: (){
        context.currentState!.showBottomSheet((context) => Container(height: MediaQuery.of(context).size.height,child: ListView(shrinkWrap: true,
          children: [
            InkWell(onTap: (){
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection('users') .get().then((value) {
      ...
      setState(() {
        all = value.docs;
        searched=  all ;
        allUsers = MyData(searched,widget.scaffoldKey);
        loading = false;
      });
