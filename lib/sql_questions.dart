...
class QuestionsActivitySQLX extends StatefulWidget {
  // GlobalKey<ScaffoldState> scaffoldKey;
  //CourseTable({required this.scaffoldKey});

  @override
  State<QuestionsActivitySQLX> createState() => _StudentsState();
}
...
class _StudentsState extends State<QuestionsActivitySQLX> {
  @override
  void initState() {
...
bool needUpdate = false;
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Container(decoration: boxShadow,margin: EdgeInsets.only(top: 15,left: 6,right: 6,bottom: 10),
          child: Padding(
            padding: const EdgeInsets.all(8.0),
        ...
        Column(
          children: [
                          ...
                          try{
                            return Container(margin: EdgeInsets.all(5),decoration: BoxDecoration(borderRadius: BorderRadius.circular(5),
                              ...
                              child: Padding(
                                ...
                                child: Row(children: [
                                  Container(width: 100,child: Text("Option # "+(index+1).toString())),
            ...
            ListView.builder(shrinkWrap: true,padding: EdgeInsets.only(top: 5),
                itemCount: newOptions.length,
                itemBuilder: (BuildContext context, int index) {
                  return Container(margin: EdgeInsets.all(0),
                    child: Padding(
                      padding: const EdgeInsets.symmetric(vertical: 5,horizontal: 5),
                      child:true?TextFormField(decoration: InputDecoration(label: Text("Option # "+(1+allOptions.length).toString()),contentPadding: EdgeInsets.symmetric(vertical: 0,horizontal: 8,)),initialValue:newOptions[index] ,onChanged: (String s){
                        newOptions[index] = s ;
                      },): Row(children: [
