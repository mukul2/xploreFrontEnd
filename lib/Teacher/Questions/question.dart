            ...
            return  Consumer<QuestionSortsprovider>(
                builder: (_, bar1, __) {
                  ...
                  return PaginatedDataTable(
                         ...
                         if(false) Padding(
                          ...
                          Padding(
                            ...
                            child: ElevatedButton(onPressed: (){
                              ...
                              showDialog(
                                  context: context,
                                  builder: (_) =>AlertDialog(title: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                    ...
                    rowsPerPage:sorted.length==0?1:( _allUsers.rowCount>n?n:_allUsers.rowCount),
