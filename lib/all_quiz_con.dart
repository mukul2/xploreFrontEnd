    ...
    return Scaffold(
      ...
      children: [
        Container(color: Colors.white,height: 59,child: Row(
          children: [
            InkWell( onTap: (){
              print("Create quix clicked");
              final format = DateFormat("yyyy-MM-dd HH:mm:ss");
               widget. scaffoldKey.currentState!.showBottomSheet((context) => Container(width: MediaQuery.of(context).size.width,
                  color: Colors.white,
                                                    ...
                                                    Container(width: 600,
                                                      child: Column(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          ...
                                                          Container(margin: EdgeInsets.all(5),decoration: boxShadow,
                                                            child: Column(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
                                                              children: [
                                                                Padding(
                                                                  padding: const EdgeInsets.all(8.0),
                                                                ...
                                                                Padding(
                                                                  padding: const EdgeInsets.all(8.0),
                                                                  child: TextField(controller: c1,decoration: InputDecoration(contentPadding: EdgeInsets.symmetric(horizontal: 8),),),
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                                                          Container(margin: EdgeInsets.all(5),decoration: boxShadow,
                                                            child: Column(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
                                                              children: [
                                                                ...
                                                                Padding(
                                                                  padding: const EdgeInsets.all(8.0),
                                                                  child: TextField(controller: c2,decoration: InputDecoration(contentPadding: EdgeInsets.symmetric(horizontal: 8)),),
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                                                          Container(margin: EdgeInsets.all(5),decoration: boxShadow,
                                                            child: Column(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
                                                              children: [
                                                                ...
                                                                Padding(
                                                                  padding: const EdgeInsets.all(8.0),
                                                                  child: TextField(controller: c3,decoration: InputDecoration(contentPadding: EdgeInsets.symmetric(horizontal: 8),),),
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                                                        if(false)  Padding(
                                                          ...
                                                          InkWell( onTap: (){
                                                            ...
                                                            child: Card(color: Colors.blue,child: Padding(
                                                              padding: const EdgeInsets.all(10.0),
                                                              child: Container(width: 400,child: Text("Save",style: TextStyle(color: Colors.white),)),
                                                            ),),
                                                          ),
              ...
              child: Container(margin: EdgeInsets.all(4), decoration: BoxDecoration(borderRadius: BorderRadius.circular(4),border: Border.all(color: Colors.blue)),
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text("Create new quiz SQL",style: TextStyle(color: Colors.blue),),
                ),
              ),
            ),
